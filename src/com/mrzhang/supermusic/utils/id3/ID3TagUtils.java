...
public class ID3TagUtils {
     ...
     * @param id3Tags ID3标签
     * @param cleanOriginal 是否清楚原始标签
     */
    public boolean setID3Tags(File sourceFile, ID3Tags id3Tags, boolean cleanOriginal){
