package com.mrzhang.supermusic.utils.id3;
...
public class ID3Tags {
    ...
    private static final String MINE_TYPE_JPEG = "image/jpeg";
    ...
    public void fillID3Tag(ID3V2_3_0Tag id3V2_3_0Tag) throws ID3Exception{
        ...
        if (coverBitmap != null && !coverBitmap.isRecycled()) {
            ...
            if (data != null) {
                ...
                APICID3V2Frame frame = new APICID3V2Frame(
                        MINE_TYPE_JPEG,
                        APICID3V2Frame.PictureType.FrontCover,
                        FRONT_COVER_DESC,
                        data);
                id3V2_3_0Tag.addAPICFrame(frame);
            }
        }
    }
    ...
    public static class Builder{
        ...
        private Builder setCoverBitmap(Bitmap coverBitmap) {
